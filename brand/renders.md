...
- Both clips drew a thin ivory floor line under the boots despite "no floor line". Painted out per frame with loop/deline.js (rows 1440–1454; an ivory pixel with ground 6 px above and below becomes ground, so boot outlines survive). Then re-encoded: MP4 24 fps CRF 18; GIF 12 fps, 540 px, 64 colours, Bayer dither.
