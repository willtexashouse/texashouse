...
original stand. The look language has been replaced with the Texas House
visual language, which is the style authority for everything here.

## Decisions taken at the brand review

- **Illustrated, not photoreal.** Every frame is a page from the 1987
  magazine described in `VISUAL_LANGUAGE.md` §1. Blocks 1, 2 and 5 replace
...
group, environment dominates. Block 4 written fresh per chapter, under 120
words, order: subject, wardrobe or form, posture, setting, one or two Texas
details, color note.
...
- Where: Beaumont salt-dome prairie. A wooden cable-tool derrick, steam
  boiler, mud pit, mule wagon at rest. Hazy sun.
- Who: four roughnecks as small figures, wool and canvas, suspenders,
  battered brims.
- What: the oil column blows through the crown block and rains down. One man
...
- Where: a Dallas trading floor seen through glass, towers going up behind it
  with cranes and curtain-wall panels rising. Texas, not New York.
- Who: traders in tailored suits with Stetsons and bolo ties as abstracted
  silhouettes; ironworkers on the steel. The lineage silhouette is one trader
  at the window, seen from behind.
- What: ticket slips thrown, a glass panel craned into place, the skyline
...
- Where: Gulf coast tidal flats, scrub and shallow water, a stainless steel
  launch vehicle on a bare pad. No branding, logos, flags or identifiable
...
Seedance is trained on photoreal footage. An illustrated register drifts
fastest under heavy action, fast cuts and handheld camera. The rules from
`VISUAL_LANGUAGE.md` §5.3 apply:
...
- The style paragraph, written from the approved chapter-1 hero frame, is
...
- Every Seedance prompt: diegetic only, inline per beat, full music
  suppression. The homepage autoplays muted; sound feeds a sound-on toggle
  and social cutdowns.
- No text in any frame. Chapter labels and headline copy are HTML overlays
  per scroll section.

## Costs (checked 2026-09-05)

- Nano Banana Pro, 21:9, batch of four variants: 2 credits.
- Seedance 2.5, 6 seconds, 1080p, 21:9, with references: 54 credits.
- Six chapters at one clean take each: about 324 credits. Retakes are the
  variable. Workspace balance at review: 863.5 credits.
