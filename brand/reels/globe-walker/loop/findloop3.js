...
(async () => {
  ...
  console.log('frames', n); console.log(cands.filter(c => c.a >= +(process.argv[5]||0) && c.a <= +(process.argv[6]||9999)).slice(0, 12).map(c => `a=${c.a} b=${c.b} len=${c.len} score=${c.s.toFixed(2)}`).join('\n'));
})();
